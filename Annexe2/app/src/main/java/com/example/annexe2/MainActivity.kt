...
class MainActivity : AppCompatActivity() {
    ...
    //Le retour du boomerang, on revient ici après sélection de la musique
    ...
    fun tempsDeLecture(chemin: InputStream): String {
        ...
        val fis:FileInputStream = chemin as FileInputStream //15554
        val bis: BufferedInputStream = BufferedInputStream(fis) //221
        var temps:Long = 0
